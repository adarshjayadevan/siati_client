...
import footerLogo from '../../assets/siati_footer.jpeg';
    ...
    >
      <Container
        ...
        <Stack direction={'row'} spacing={6}>
          <Box as="a" href={'#'} onClick={()=>navigate('/')}>
            Home
          </Box>
          <Box as="a" href={'#'} onClick={()=>navigate('/about')}>
            About
          </Box>
          <Box as="a" href={'#'} onClick={()=>navigate('/services')}>
            Services
          </Box>
          <Box as="a" href={'#'} onClick={()=>navigate('/contact')}>
            Contact
          </Box>
        </Stack>
        {/* <Text>Aeronautical Society Buildings, Surnjandas Road,</Text>
          <Text> (off) Old Madras road, Bangalore-560075</Text> */}
      </Container>
